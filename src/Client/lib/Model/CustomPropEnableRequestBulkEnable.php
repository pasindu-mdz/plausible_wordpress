<?php
/**
 * CustomPropEnableRequestBulkEnable
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CustomPropEnableRequestBulkEnable Class Doc Comment
 *
 * @category    Class
 ...
 */
class CustomPropEnableRequestBulkEnable implements ModelInterface, ArrayAccess, \JsonSerializable {
	 ...
	 * @var string
	 */
	protected static $openAPIModelName = 'CustomProp_EnableRequest_BulkEnable';
	...
	public function setCustomProps( $custom_props ) {
		...
		if ( ( count( $custom_props ) < 1 ) ) {
			throw new \InvalidArgumentException(
				'invalid length for $custom_props when calling CustomPropEnableRequestBulkEnable., number of items must be greater than or equal to 1.'
			);
		}
