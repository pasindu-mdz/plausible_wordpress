...
/**
 * PaymentRequiredError Class Doc Comment
 *
 * @category    Class
 * @description The response that is returned when the user makes a request that cannot be processed due to their subscription limitations.
 * @package     Plausible\Analytics\WP\Client
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentRequiredError implements ModelInterface, ArrayAccess, \JsonSerializable {
	 ...
	 * @var string
	 */
	protected static $openAPIModelName = 'PaymentRequiredError';
