 ...
 */
class GoalCreateRequestCustomEvent implements ModelInterface, ArrayAccess, \JsonSerializable {
	public const DISCRIMINATOR = null;

	public const GOAL_TYPE_GOAL_CUSTOM_EVENT = 'Goal.CustomEvent';
	 ...
	 * @var string
	 */
	protected static $openAPIModelName = 'Goal.CreateRequest.CustomEvent';
	...
	public function __construct( array $data = null ) {
		...
		$this->setIfExists( 'goal_type', $data ?? [], 'Goal.CustomEvent' );
	}
	...
	public function getGoalTypeAllowableValues() {
		return [
			self::GOAL_TYPE_GOAL_CUSTOM_EVENT,
		];
	}
